...
> **Superseded (2026-07-31, same day).** This is the pre-wave *baseline*.
> After roadmap waves 1–3 shipped, the comparison was re-run —
> [`matplotlib-gallery-audit-rerun.md`](matplotlib-gallery-audit-rerun.md)
> has the current numbers (in-scope achievable 47% → 60%; core categories
> 57% → 73%). Keep this file for the before-picture and the original probes.
