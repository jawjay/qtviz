...
| **1.2 — Axis & tick control** ✅ (shipped 2026-07-31) | ticks users actually ask for; time axes finished | [D101] explicit ticks/labels · [D102] format templates · [D103] minor ticks + rotation · [D104] calendar-aligned mpl time ticks · [D105] raster color norms · *interleave: streaming×datashader* | ~20 examples |
| **1.3 — Meshes, fields & layout composition** ✅ (shipped 2026-07-31) | scientific 2-D + real dashboards | [D106] `Mesh` (pcolormesh) · [D107] `Quiver` · [D108] mosaic layouts + ratios + suptitle | ~20 examples |
