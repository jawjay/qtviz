...
| 31 | [`31_axis_labels.py`](31_axis_labels.py) | **Axis labels & titles** — `OverlayOptions(title, x_label, y_label)` on each surface; per-pane labels in a `Layout`; renders identically on every backend. | <a href="../docs/images/examples/31_axis_labels.png"><img src="../docs/images/examples/31_axis_labels.png" width="260" alt="31_axis_labels"></a> |
